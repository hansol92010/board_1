...
<div class="container">
	...
	<div class="d-flex">
		...
		<div class="ml-auto input-group" style="width:50%;">
			...
			<input type="text" name="searchValue" id="searchValue" value="${searchValue}" class="form-control mx-1" maxlength="20" style="width:auto;ime-mode:active" placeholder="조회값을 입력하세요" />
